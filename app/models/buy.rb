class Buy
  ...
  with_options presence: true do
    validates :user_id, :item_id, :post_code, :sender_id, :municipalities, :house_number, :tel, :token, presence: true
  ...
  def save
    ...
    Address.create(post_code: post_code, sender_id: sender_id, municipalities: municipalities, house_number: house_number, building_name: building_name, tel: tel, buying_record_id: buying_record.id)
  end
end